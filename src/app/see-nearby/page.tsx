...
const SeeNearby = () => {
    return (
        <section className='see-nearby'>
            <div className='container see-nearby__container'>
                <h2 className={styles.seeNearby__title}>
                    What to see near our Apart Hotel Villa Manja</h2>
                ...
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        <img src='/images/nearby/1st.webp'
                        ...
                        <div className={styles.seeNearby__pointText}>
                            <p className={styles.seeNearby__pointDescription}>
                                ...
                                Lake Bohinj and the peaks of the Julian Alps.
                            </p>
                        </div>
                    </div>
                </div>
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        <div className={styles.seeNearby__pointText}>
                            <p className='see-nearby__point-description'>
                        ...
                        <img src='/images/nearby/2nd.webp' alt='Lake Bohinj' className={styles.seeNearby__pointImage}/>
                    </div>
                </div>
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        <img src='/images/nearby/3rd.webp' alt='Savica Waterfall'
                             className={styles.seeNearby__pointImage}/>
                        <div className={styles.seeNearby__pointText}>
                            <p className='see-nearby__point-description'>
                ...
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        ...
                        <img src='/images/nearby/4th.webp' alt='Mount Vogel' className={styles.seeNearby__pointImage}/>
                    </div>
                </div>
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        <img src='/images/nearby/5th.webp' alt='Lake Bled' className={styles.seeNearby__pointImage}/>
                        <div className={styles.seeNearby__pointText}>
                            <p className='see-nearby__point-description'>
                                ...
                                appreciate the beauty of the panoramic view. Definitely, you need to go here.
                            </p>
                        </div>
                    </div>
                </div>
                <div className={styles.seeNearby__points}>
                    <div className={styles.seeNearby__point}>
                        ...
                        <img src='/images/nearby/6th.webp' alt='Vintgar Gorge'
                             className={styles.seeNearby__pointImage}/>
                    </div>
                </div>
            </div>
