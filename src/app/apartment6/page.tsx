...
const images = [
    { src: '/images/apartment6/1st.webp', title: 'Entrance to the apartment by stairs to the third floor', description: 'Entrance to the apartment by stairs to the third floor' },
    { src: '/images/apartment6/2nd.webp', title: 'Entrance to the apartment', description: 'General view from corridor' },
    { src: '/images/apartment6/3rd.webp', title: 'Entrance to the apartment', description: 'Corridor of the apartment' },
    { src: '/images/apartment6/4th.webp', title: 'Bathroom', description: 'The bathroom has a shower, washbasin and washing machine' },
    { src: '/images/apartment6/5th.webp', title: 'Bathroom', description: 'The bathroom has a shower, washbasin and washing machine' },
    { src: '/images/apartment6/6th.webp', title: 'Corridor', description: 'View from the entrance to the kitchen' },
    { src: '/images/apartment6/7th.webp', title: 'Bedroom', description: 'The bedroom has a 160x200 cm bed and a wardrobe' },
    { src: '/images/apartment6/8th.webp', title: 'Bedroom', description: 'View from entrance' },
    { src: '/images/apartment6/10th.webp', title: 'Bedroom', description: 'Window in the bedroom' },
    { src: '/images/apartment6/11th.webp', title: 'Bedroom', description: 'The bedroom has a 160×200 cm bed and a wardrobe' },
        ...
        <section className={'apartment3'}>
            <div className={`container apartment3__container`}>
                <div className={'apartment3__textWrapper'}>
                    <h1 className={'apartment3__header'}>Apartment No. 6 <br/>
                    ...
                    <ul className={'apartment3__list'}>
                        <li>Bedroom with queen-size bed 160×200 cm with orthopedic mattress</li>
